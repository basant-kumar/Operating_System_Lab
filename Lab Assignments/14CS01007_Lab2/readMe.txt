...
i)Solution have two source code files and one data folder which contains all files for server which will be send to client.
...
iii)To test programms first run ftp_server.c program where your ip address for socket will set automatically of your machine ip address and port number will be passed at the time of execution.
...
e.g. user:$ gcc ftp_client.c -o client
     user:$ ./client 192.168.1.25 8888 file.txt
